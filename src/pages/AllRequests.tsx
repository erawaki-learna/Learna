        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-navy/10">
          ...
          {filteredRequests.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-navy/60">No requests found with the selected filter.</p>
            </div>
          ) : (
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredRequests.map((request) => (
                    <tr
                      key={request.id}
                      className="border-b border-navy/5 hover:bg-cream/50 transition-colors cursor-pointer"
